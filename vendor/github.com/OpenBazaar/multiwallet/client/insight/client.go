...
func (i *InsightClient) GetTransaction(txid string) (*client.Transaction, error) {
...
func (i *InsightClient) GetBlocksBefore(to time.Time, limit int) (*client.BlockList, error) {
