...
func (w *BitcoinWallet) buildTx(amount int64, addr btc.Address, fee wi.Fee, optionalOutput *wire.TxOut) (*wire.MsgTx, error) {
	// Check for dust
...
func (w *BitcoinWallet) buildSpendAllTx(addr btc.Address, fee wi.Fee) (*wire.MsgTx, error) {
	tx := wire.NewMsgTx(1)
