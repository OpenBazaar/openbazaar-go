...
1. Look through the [issues for this repo](https://github.com/filecoin-project/go-multistore/issues) for relevant discussions.
...
1. If you like, check out [current PRs](https://github.com/filecoin-project/go-multistore/pulls) to see how others do it.
...
Active development of `go-multistore` occurs on the `master` branch. All PRs should be made to the `master` branch, which is the default branch on Github.
