...
1. Look through the [issues for this repo](https://github.com/filecoin-project/go-data-transfer/issues) for relevant discussions.
...
1. If you like, check out [current PRs](https://github.com/filecoin-project/go-data-transfer/pulls) to see how others do it.
