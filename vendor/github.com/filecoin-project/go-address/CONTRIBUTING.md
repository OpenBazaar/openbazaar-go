...
1. Look through the [issues for this repo](https://github.com/filecoin-project/go-address/issues) for relevant discussions.
...
1. If you like, check out [current PRs](https://github.com/filecoin-project/go-address/pulls) to see how others do it.
