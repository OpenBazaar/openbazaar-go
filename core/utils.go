...
func (n *OpenBazaarNode) BuildTransactionRecords(contract *pb.RicardianContract, records []*spvwallet.TransactionRecord, state pb.OrderState) (paymentRecords []*pb.TransactionRecord, refundRecord *pb.TransactionRecord, err error) {
