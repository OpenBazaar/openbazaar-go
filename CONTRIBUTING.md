...
Additionally, we like to keep the [Go Report Card](https://goreportcard.com/report/github.com/OpenBazaar/openbazaar-go) score an A or better. So keep those other tests in mind when you commit.
