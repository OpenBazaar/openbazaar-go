...
func init() {
	...
	sh2, _ := wire.NewShaHashFromStr("82998e18760a5f6e5573cd789269e7853e3ebaba07a8df0929badd69dc644c5f")
...
func TestStxoGetAll(t *testing.T) {
	...
	if hex.EncodeToString(stxos[0].Utxo.ScriptPubkey) != hex.EncodeToString(stxo.Utxo.ScriptPubkey) {
		t.Error("Stxo db returned wrong scriptPubKey")
	}
