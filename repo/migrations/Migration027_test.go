...
func TestMigration027(t *testing.T) {
	...
	index := []*migrations.Migration027_ListingData{extractListingData27(listing)}
	...
	var listingIndex []migrations.Migration027_ListingData
...
func extractListingData27(listing *pb.Listing) *migrations.Migration027_ListingData {
	...
	ld := &migrations.Migration027_ListingData{
		Hash:         "aabbcc",
		Slug:         listing.Slug,
		...
		Thumbnail:    migrations.Migration027_Thumbnail{listing.Item.Images[0].Tiny, listing.Item.Images[0].Small, listing.Item.Images[0].Medium},
		Price: migrations.Migration027_Price{
