...
var (
	...
	mainnetCryptoDefinitions = map[string]CurrencyDefinition{
		...
		"DAI": {Name: "DAI", Code: CurrencyCode("DAI"), CurrencyType: Crypto, Divisibility: 18, BlockTime: 10 * time.Second},
	}
	testnetCryptoDefinitions = map[string]CurrencyDefinition{
		...
		"TDAI": {Name: "Testnet DAI", Code: CurrencyCode("TDAI"), CurrencyType: Crypto, Divisibility: 18, BlockTime: 10 * time.Second},
	}
