...
func (OrderState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_orders_cbc35a76a0d06f28, []int{0}
}
...
func init() { proto.RegisterFile("orders.proto", fileDescriptor_orders_cbc35a76a0d06f28) }

var fileDescriptor_orders_cbc35a76a0d06f28 = []byte{
