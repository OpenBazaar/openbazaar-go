...
func (*Post) Descriptor() ([]byte, []int) {
	return fileDescriptor_posts_95f00fa3ba0bd72e, []int{0}
}
...
func (*Post_Image) Descriptor() ([]byte, []int) {
	return fileDescriptor_posts_95f00fa3ba0bd72e, []int{0, 0}
}
...
func (*SignedPost) Descriptor() ([]byte, []int) {
	return fileDescriptor_posts_95f00fa3ba0bd72e, []int{1}
}
...
func init() { proto.RegisterFile("posts.proto", fileDescriptor_posts_95f00fa3ba0bd72e) }

var fileDescriptor_posts_95f00fa3ba0bd72e = []byte{
